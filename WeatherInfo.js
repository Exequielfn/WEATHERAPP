        ...
        <div>
            ...
            {props.temperature ?
                <div className="card card-body mt-2 animated fadeInUp" >
                    ...
                    {
                        props.temperature &&
                        <p><i className="fas fa-temperature-low"></i> Temperature: {props.temperature} ℃ <h4></h4>
                        <img src={`http://openweathermap.org/img/wn/${props.icon}@2x.png`}></img>{props.description}</p>
                    }
                    {
                        props.humidity &&
